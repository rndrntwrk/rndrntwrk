done ? r(e.value) : (t = e.value, t instanceof i ? t : new i(function(e) {
  e(t)
})).then(a, s)
}
...
h.q.updatePathPrefix(e.path), h.q.updateLanguage(e.language)
    ...
    g.content && (f = function(e) {
        ...
        switch (p && p[1] && (t = p[1].toLowerCase()), t) {
          case n:
            return i = u(e), s.test(e) || (h = i.getElementsByTagName(r)[0]) && h.parentNode.removeChild(h), l.test(e) || (h = i.get